...
class Video:
    def __init__(self, videoURL: str, id: str = None, duration: int = None, videoName: str = None, category: str = None, date: str = None, thumbnail: str = None, description: str = None, channelID: str = None) -> None:
        self.id = id
    ...
    def getChannelObject(self, channels):
        for channel in channels:
            if channel.id == self.channelID:
                return channel
        print('Didnt find an option ', self.channelID)
